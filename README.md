...
<p align="center">
 <a href="https://github.com/Abanoub-20180003/Project-3-Data-Warehouse-on-AWS">
  <img src="./images/ETL.jpg" alt="Logo" width="250" height="125">
 </a>
 <h3 align="center">Data Warehouses with AWS Redshift</h3>
 <p align="center">
  Udacity Nanodegree Course Project 3
  <br />
  <a href=https://github.com/Abanoub-20180003/Project-3-Data-Warehouse-on-AWS><strong>Explore the repository»</strong></a>
  <br />
  <br />
 </p>
...
```sh
git clone https://github.com/Abanoub-20180003/Project-3-Data-Warehouse-on-AWS.git
```
...
2. Edit the `create-config.py` configuration python script and fill in the AWS Access Key and Secret Key fields, Then Run this file to create config file 
